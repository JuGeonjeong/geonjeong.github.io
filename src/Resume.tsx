...
export default function Resume() {
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-b from-gray-800 via-gray-700 to-gray-900 text-white">
      <div className="max-w-3xl w-full p-6 space-y-8 text-center">
        <section>
          <h1 className="text-4xl font-bold text-white">주건정</h1>
          ...
          <div className="flex justify-center gap-4 mt-4">
            <Button>
              <a
                ...
                href="https://github.com/JuGeonjeong"
              >
